...
from app_ml.utils.index import (
    NativeGaussianBlur,
...
class PatchCore(KNNExtractor):
    ...
    def forward(self, sample):
        ...
        w_dist = torch.cdist(m_star, self.patch_lib)  # type: ignore # find knn to m_star pt.1
    ...
    def export(self, save_name: str):
        ...
        scripted_predictor.save(f"{settings.MODEL_OUTPUT_DIR}/{save_name}.pt")
